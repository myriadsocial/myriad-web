...
const moduleExports = {
  ...
  publicRuntimeConfig: {
    ...
    nearNetworkId: process.env.NETWORK_ID ?? 'testnet',
    nearNodeUrl: process.env.NODE_URL ?? 'https://rpc.testnet.near.org',
    nearWalletUrl: process.env.WALLET_URL ?? 'https://wallet.testnet.near.org',
    nearHelperUrl: process.env.HELPER_URL ?? 'https://helper.testnet.near.org',
  },
  sentry: {
