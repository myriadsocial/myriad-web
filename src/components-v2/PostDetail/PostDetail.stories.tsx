...
export default {
  ...
  argTypes: {},
} as ComponentMeta<typeof PostDetailComponent>;

const Template: ComponentStory<typeof PostDetailComponent> = args => (
  <PostDetailComponent {...args} />
);
...
export const TwitterPost = Template.bind({});
TwitterPost.args = {
  post: {
...
export const RedditPost = Template.bind({});
RedditPost.args = {
  post: {
