...
export class Near implements IProvider {
  ...
  async claimTipBalances(
    ...
    try {
      ...
      const contract = await this.contractInitialize(tippingContractId, 'get_tips_balances');
