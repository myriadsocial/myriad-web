...
export const CommentHistoryListContainer: React.FC<CommentHistoryListContainerProps> =
  props => {
    const { profile } = props;

    const styles = useStyles();
    const { comments, hasMore, sort, load, loadMore, sortBy } =
      useCommentHistory(profile);
