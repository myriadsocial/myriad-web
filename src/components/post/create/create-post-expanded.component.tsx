...
export const CreatePostExpandedComponent = forwardRef(
  ({ onSubmit, text, user }: CreatePostExpandedComponentProps, ref: React.Ref<CreatePostExpandedComponentRefProps>) => {
    ...
    return (
      <Card className={styles.card}>
        ...
        <CardActions className={styles.action}>
          <Button variant="contained" size="large" color="primary" disabled={submitting} className={styles.postButton} onClick={savePost}>
            Post Now
          </Button>
        </CardActions>
      </Card>
