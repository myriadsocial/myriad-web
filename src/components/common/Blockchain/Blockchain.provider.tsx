...
import {BlockchainProviderProps} from './Blockchain.interface';
import {useStyles} from './Blockchain.style';
...
export const BlockchainProvider: React.ComponentType<BlockchainProviderProps> = ({
  ...
  return (
    <>
      <BlockchainContext.Provider value={{provider, switchNetwork: shiftNetwork}}>
        {children}
