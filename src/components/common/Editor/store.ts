...
export const getEditor = (editor: Editor) =>
  getTEditor<EditorValue, Editor>(editor);
...
export const usePlateEditorRef = (id?: string) =>
  usePlateEditorRefBase<EditorValue, Editor>(id);
export const getPlateEditorRef = (id?: string) =>
  getPlateEditorRefBase<EditorValue, Editor>(id);
export const usePlateEditorState = (id?: string) =>
  usePlateEditorStateBase<EditorValue, Editor>(id);
export const useEditorSelectors = (id?: string) =>
  usePlateSelectors<EditorValue, Editor>(id);
export const getEditorSelectors = (id?: string) =>
  getPlateSelectors<EditorValue, Editor>(id);
export const getEditorActions = (id?: string) =>
  getPlateActions<EditorValue, Editor>(id);
