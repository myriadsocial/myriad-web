...
export const TimelineFilterContainer: React.FC<TimelineFilterContainerProps> =
  props => {
    const { filters } = props;

    const dispatch = useDispatch();
    const { originType, filterByOrigin, sortTimeline } =
    ...
    const [timelineOrder, setTimelineOrder] = useState<TimelineOrderType>(
