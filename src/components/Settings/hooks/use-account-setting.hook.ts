  ...
  return [
    {
      ...
      subtitle: i18n.t(
        'Setting.List_Menu.Account_Setting.Account_Privacy.Subtitle',
      ),
    },
    {
      id: 'socialMediaPrivacy',
      title: i18n.t(
        'Setting.List_Menu.Account_Setting.Social_Media_Privacy.Title',
      ),
      subtitle: i18n.t(
        'Setting.List_Menu.Account_Setting.Social_Media_Privacy.Subtitle',
      ),
    },
  ];
};
